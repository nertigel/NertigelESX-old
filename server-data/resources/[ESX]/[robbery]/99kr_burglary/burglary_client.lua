...
local burglaryInside = {
    ["Weed"] = { x = 342.23, y = -1003.29, z = -99.0, item = 'weed', amount = math.random(4,11)},
    ["Diamond"]  = {x = 338.14, y = -997.69, z = -99.2, item = 'diamond', amount = math.random(1,2)},
    ...
    ["Rolex"]  = { x = 345.3, y = -995.76, z = -99.2, item = 'rolex', amount = math.random(1,2)},
    ["Jeweles"] = { x = 346.14, y = -1001.55, z = -99.2, item = 'jeweles', amount = math.random(1,3)},
    ["Ring"] = { x = 347.23, y = -994.09, z = -99.2, item = 'ring', amount = math.random(1,2)},
    ["Golden Necklace"] = { x = 339.23, y = -1003.35, z = -99.2, item = 'necklace', amount = math.random(1,5)}
}
