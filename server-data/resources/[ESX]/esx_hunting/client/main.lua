...
function StartHuntingSession()
	...
	if OnGoingHuntSession then
		...
		RemoveWeaponFromPed(PlayerPedId(), GetHashKey("WEAPON_SNSPISTOL"), true, true)
		...
		HuntCar = CreateVehicle(GetHashKey('riata'), Positions['SpawnATV'].x, Positions['SpawnATV'].y, Positions['SpawnATV'].z, 169.79, true, false)

		GiveWeaponToPed(PlayerPedId(), GetHashKey("WEAPON_MUSKET"),45, true, false)
		GiveWeaponToPed(PlayerPedId(), GetHashKey("WEAPON_SNSPISTOL"),45, true, false)
