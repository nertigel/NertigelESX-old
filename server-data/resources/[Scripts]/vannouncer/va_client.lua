...
m.messages = {   
    '^1 Welcome to ^2 New Era Roleplay ^1 go ahead and join our Discord server ^7| ^4discord.gg/PKpTJkN',
    '^1Don\'t forget to join our ^4discord ^7@ ^4discord.gg/PKpTJkN',
    '^1If you need help with anything feel free to /report or join our Discord server ^7@ ^4discord.gg/PKpTJkN',
}
